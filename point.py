class Point:
    """
    Simple way to represent apoint in 2D space
    """
    ...
    def __lt__(self, other):
        """
        retuns TRue if self is larger than other point
        :param other: the other point to comapre against
        :return: True or False
        """
if __name__ == "__main__": #Protects the code from import runs!!
    p1 = Point(1, 2)
    p2 = Point(3, 4)
    print(p1.x, p1.y)
    print(p2.x, p2.y)
